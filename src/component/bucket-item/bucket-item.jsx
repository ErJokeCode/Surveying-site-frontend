import styles from "../bucket-item/bucket-item.module.css"
export default function BucketItem({data, allItems, setAllItems}) {
    const delThisFromBucket = () => {
        const i = allItems.findIndex(el => el.id === data.id);
        const newBucket = [
            ...allItems.slice(0, i),
            ...allItems.slice(i + 1)
          ]
        setAllItems(newBucket)
    ...
    return (
        <div className={styles.container}>
            ...
            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={delThisFromBucket}>
